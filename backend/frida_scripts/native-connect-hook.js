/*
 * VENDORED VERBATIM from HTTP Toolkit's frida-interception-and-unpinning project.
 * Do not edit the body below — update by re-vendoring from upstream so the tested
 * sockaddr/SOCKS5 logic stays intact. The config globals it reads (PROXY_HOST,
