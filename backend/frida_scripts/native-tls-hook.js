/*
 * VENDORED VERBATIM from HTTP Toolkit's frida-interception-and-unpinning.
 * Hooks native TLS libs (Android conscrypt libssl.so, Cronet libsscronet.so,
 * iOS BoringSSL) so connections using our CA are trusted at the NATIVE layer —
 * the piece our Java-only android-unpinning.js can't reach (Flutter, Cronet,
 * GMS/connectivity checks, native pinning). Reads CERT_DER + waitForModule from
 * config-helpers.js. Do not hand-edit; re-vendor from upstream. See NOTICE.md.
 *
 */
